      ...
      <section className="py-20 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {people.map((person) => (
              <Card key={person.name} className="hover:shadow-lg transition-all border-t-4 border-t-teal">
                <CardContent className="pt-8 pb-6">
                  <div className="w-16 h-16 rounded-full bg-navy/5 mx-auto mb-4 flex items-center justify-center">
                    {person.type === "Board" ? (
                  ...
                  <h3 className="font-semibold text-navy text-center text-lg">{person.name}</h3>
                  <p className="text-sm text-teal text-center mb-1">{person.role}</p>
