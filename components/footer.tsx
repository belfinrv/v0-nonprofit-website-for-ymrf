      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <a
              href="https://www.facebook.com/photo/?fbid=122093312553335162&set=a.122093309967335162"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-white/70 hover:text-[#1FB6A6] transition-colors text-sm"
            >
